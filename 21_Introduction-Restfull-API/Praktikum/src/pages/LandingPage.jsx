  ...
  return (
    <>
      ...
      <section className="flex flex-col items-center justify-center bg-[#F3F5FA] h-[35vh] font-[Jost] gap-3">
        <h4 className="text-2xl font-medium text-[#37517E]">
          Join Our Newsletter
        </h4>
        <p>
        ...
        <div className="">
          <input
            className=" w-[30rem] rounded-full p-2 shadow-sm"
            type="email"
            required=""
          />
          <button className=" rounded-full bg-[#47B2E4;] text-white p-2 px-5 shadow-sm">
            Subscribe
          </button>
        </div>
      </section>
